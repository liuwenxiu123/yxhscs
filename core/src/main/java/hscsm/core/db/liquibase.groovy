...
//表结构
databaseChangeLog(logicalFilePath: "hscsm/core/db/liquibase.groovy") {
...
//    migrationHelper.dbmigrate(dbType,["com/hand/hap","hscsm/core","hscs/core"] ,["table", "data", "patch"])
    //加载顺序table, "data", "patch
    migrationHelper.dbmigrate(dbType,["com/hand/hap","hscsm/core","hscs/core","hitf/core","yxhscs/core"] ,["table", "data", "patch"])
